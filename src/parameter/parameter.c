...
const struct parameter parameters[] PROGMEM = {
    [SQ1_ENABLED] = {&assigner_enabled[0], BOOL, 0, 0, 1},
    ...
    [SQ2_ENABLED] = {&assigner_enabled[1], BOOL, 0, 0, 1},
    ...
    [TRI_ENABLED] = {&assigner_enabled[2], BOOL, 0, 0, 1},
    ...
    [NOISE_ENABLED] = {&assigner_enabled[3], BOOL, 0, 0, 1},
    ...
    [DMC_ENABLED] = {&assigner_enabled[4], BOOL, 0, 1, 1},
